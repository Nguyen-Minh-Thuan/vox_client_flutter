/// Badge shown on a weakness row. Không có field `severity` ở mức tiêu chí, nên suy từ
/// điểm `weakness` thật qua ngưỡng cố định (một con số thật được chia khoảng, không phải
/// giá trị bịa).
