...
///
/// Gates on the stored onboarding flag: first-time learners get the intro that
/// launches [OnboardingFlow], everyone else lands on [PracticeHomeScreen].
...
class PracticeTabState extends State<PracticeTab> {
  ...
  Future<void> _load() async {
    final done = await _preferences.getPracticeOnboardingDone();
    if (!mounted) return;
    setState(() {
      _onboarded = done;
      _loading = false;
