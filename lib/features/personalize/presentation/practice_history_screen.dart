...
/// New screen -- real `myPracticeHistory(limit)`, list of past sessions.
/// No tap-through to `SessionSummaryScreen` (that needs rubric/repeated-error
/// detail no query returns; left as-is, untouched mock).
...
class _PracticeHistoryScreenState extends State<PracticeHistoryScreen> {
  ...
  Widget _buildBody(AppLocalizations l10n) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, index) => _HistoryEntryRow(entry: _entries[index]),
    );
  }
}
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: positive ? AppColors.chipGreenFg : AppColors.chipOrangeFg,
                ),
              ),
            ),
          ],
